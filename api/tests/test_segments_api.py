...
def test_segments_bbox_returns_sidewalks_without_suppression(db_connection) -> None:
    _insert_segment(
        db_connection,
        "seg-morris",
    ...
    assert "seg-morris-sidewalk-west" in feature_ids
    assert "seg-morris-sidewalk-east" in feature_ids
